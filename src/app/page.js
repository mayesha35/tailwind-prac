...
export default function Home() {
  return (
    <>
     <div className="bg-[#c5c7cd] pb-28">
     <div className="bg-[url('../assets/banner.jpg')] bg-center h-screen bg-cover bg-no-repeat">
        <div className='w-full h-screen bg-[radial-gradient(circle,rgba(60,49,122,0.7)28%,rgba(81,81,184,0.9)60%,rgba(153,161,177,0.8)89%)] flex justify-center items-center'>
           <div className='container text-center text-white'>
             <h1 className='lg:text-[40px] md:text-[20px] sm:text-[15px] font-poppins font-bold lg:px-[450px]'>Building stellar websites for early startups</h1>
             <p className='font-poppins text-md px-[400px] text-white my-5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt. Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit est eaque ut numquam.</p>
      ...
      <div className=" container py-14">
        <h2 className="text-[30px] font-poppins font-bold lg:mx-[470px] md:mx-[300px] text-center mb-12">Design that solves problems, one product at a time</h2>
